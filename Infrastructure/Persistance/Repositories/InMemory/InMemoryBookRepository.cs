...
public class InMemoryBookRepository : IBookRepository {
    ...
    private static readonly Dictionary<BookId, Book> _books = new() {
       { BookId.Create(Guid.Empty), new Book(BookId.Create(Guid.Empty), DateTime.UtcNow, DateTime.UtcNow, [
            new BookPage(PageId.Create(Guid.Parse("00000000-0000-0000-0000-000000000001")), new SizeF(1000, 1414), DateTime.UtcNow, DateTime.UtcNow),
            new BookPage(PageId.Create(Guid.Parse("00000000-0000-0000-0000-000000000002")), new SizeF(1000, 1414), DateTime.UtcNow, DateTime.UtcNow)
        ]) }
    };
}
